...
// iterates over each value and applies a function
...
const init = () => {
    ...
    // .change-styles and #change-styles?
    const changeStyle = $('#change-style');
    const changeStyle2 = $('.change-style');
    changeStyle.css('color', 'red');
    changeStyle2.css('color', 'pink');
    changeStyle2.css('color', 'green');
    changeStyle.css('color', 'lightblue');

    // (.) signifies a class name
    // (#) signifies an element with a specific id attribute
...
//    would it be able to find if we don't mention it specifically?
